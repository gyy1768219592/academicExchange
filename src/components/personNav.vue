          ...
          <a class="ant-dropdown-link" @click="e => e.preventDefault()">
            <div>
              ...
              >
                <a-icon
                  type="bell"
                  style="font-size: 25px; margin-top: 3px; color: #250d00;"
                  @click="showDrawer"
                />
              </a-badge>
              <a-drawer
                    ...
                    <div v-for="(item, index) in unreadnoticelist" :key="index">
                      ...
                      >
                        ...
                        <a-button
                          ...
                          class="read-agree"
                          @click="
                            agreeTeamInvitation(item.teamid, item.noticeid)
                          "
                          v-if="item.type === 1"
                          >同意</a-button
                        >
                        <a-button
                          ...
                          class="read-disagree"
                          @click="
                            disagreeTeamInvitation(item.teamid, item.noticeid)
                          "
                          v-if="item.type === 1"
                          >拒绝</a-button
                        >
                        ...
                        <a-button
                          ...
                          class="read-agree"
                          @click="
                            agreeCooperateInvitation(item.docid, item.noticeid)
                          "
                          v-if="item.type === 4"
                          >同意</a-button
                        >
