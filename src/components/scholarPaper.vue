      ...
      <div class="result-list">
        <a-list item-layout="vertical" size="large" :data-source="paperList">
          <a-list-item slot="renderItem" key="item.title" slot-scope="item">
            <a-button type="link" icon="star" slot="actions" class="result-list-button">收藏</a-button>
      ...
      paperList: [
        {
          ...
          citationCount: 103,
          abstract:
            "云计算代表IT领域向集约化,规模化与专业化道路发展的趋势,是IT领域正在发生的深刻变革.但它在提高使用效率的同时,为实现用户信息资产安全与隐私保护带来极大的冲击与挑战.当前,安全成为云计算...",
        },
        {
          title:
        ...
        {
          title: "<span class='highlight'>计算</span>机云<span class='highlight'>计算</span>探析",
          author: "王晓燕",
        ...
        {
          title: "<span class='highlight'>计算</span>与<span class='highlight'>计算</span>哲学",
        ...
        {
          title: "面向<span class='highlight'>计算</span>社会的<span class='highlight'>计算</span>素质培养",
          author: "王飞跃",
        ...
        {
          title: "云<span class='highlight'>计算</span>的数据<span class='highlight'>计算</span>与存储",
          author: "董玉; 管群",
        ...
        {
          title: "云<span class='highlight'>计算</span>与网络<span class='highlight'>计算</span>",
          author: "常浩",
        ...
        {
          title: "<span class='highlight'>计算</span>机云<span class='highlight'>计算</span>研究分析",
          author: "于艳东; 姚玉阁",
