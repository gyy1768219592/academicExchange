<template>
  <div>
    <a-modal
      ...
      @cancel="handleCancel"
    >
      <a-textarea v-model="appealinfo" placeholder="请填写相关申诉信息" :auto-size="{ minRows: 3, maxRows: 5 }" />
      <div>
        <span>证明材料:</span>
        <a-upload-dragger
          name="file"
...
export default {
  props: ["visible", "dataScholar_id", "type"],
  data() {
    return {
  ...
  methods: {
    handleOk() {
      ...
      params.append("towardsId", this.dataScholar_id);
